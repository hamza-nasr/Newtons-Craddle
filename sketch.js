...
function setup() {
	...
	chain1 = new Chain(ball1.point,roof.body);
	chain2 = new Chain(ball2.point,roof.body);
	chain3 = new Chain(ball3.point,roof.body);
	chain4 = new Chain(ball4.point,roof.body);
